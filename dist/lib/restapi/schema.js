 ...
 * @param {knex} db Database Query Object
 */
class PostgresSQL extends DbSchema {
    constructor(db) {
        super(db);
        this.queries = {
 ...
 * @param {knex} db Database Query Object
 */
class SQLite3 extends DbSchema {
    constructor(db) {
        super(db);
        this.queries = {
